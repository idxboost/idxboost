            ...
            success: function(response) {
                ...
                if (paging.pages > 1) {
                    ...
                    if (paging.prev_page && paging.pages > 1) {
                        paginationHTML.push('<a role="button" data-page="1" title="'+word_translate.first_page+'" id="firstp" class="ad visible">');
                    ...
                    if (paging.prev_page) {
                        paginationHTML.push('<a role="button" data-page="' + (paging.current - 1) + '" title="Prev Page" id="prevn" class="arrow clidxboost-icon-arrow-select prevn visible">');
                    ...
                    if (paging.next_page) {
                        paginationHTML.push('<a role="button" data-page="' + (paging.current + 1) + '" title="Prev Page" id="nextn" class="arrow clidxboost-icon-arrow-select nextn visible">');
                        paginationHTML.push('<span>'+word_translate.next_page+'</span>');
                        paginationHTML.push('</a>');
                    }
                    if (paging.next_page && paging.pages > 1) {
                        paginationHTML.push('<a role="button" data-page="' + paging.pages + '" title="'+word_translate.first_page+'" id="lastp" class="ad visible">');
                        paginationHTML.push('<span class="clidxboost-icon-arrow-select"></span>');
                        paginationHTML.push('<span class="clidxboost-icon-arrow-select"></span>');
        ...
        return function() {
            if (property.group.length > 1) {
                ...
                for (var i = 0, l = property.group.length; i < l; i++) {
                    ...
                    infobox_content.push('<li class="price-sf"><span>$' + property_group.price_sqft + ' </span>/ '+word_translate.sqft+'<span>($' + property_group.price_sqft_m2 + ' m²)</span></li>');
                    infobox_content.push('</ul>');
                    ...
                    if (
                        ...
                        infobox_content.push('<img title="' + property_group.address_short + ', ' + property_group.address_large + '" alt="' + property_group.address_short + ', ' + property_group.address_large + '" src="' + property_group.gallery[0] + '"><img src="'+__flex_g_settings.board_info.board_logo_url+'" style="position: absolute;bottom: 10px;z-index: 2;width: 80px;right: 10px;height:auto">');
                    }else{
                ...
                infobox_content.push('<li class="living-size"> <span>' + _.formatPrice(property.item.sqft) + '</span> '+word_translate.sqft+'<span>(' + property.item.living_size_m2 + ' m²)</span></li>');
                infobox_content.push('<li class="price-sf"><span>$' + property.item.price_sqft + ' </span>/ '+word_translate.sqft+'<span>($' + property.item.price_sqft_m2 + ' m²)</span></li>');
                infobox_content.push('</ul>');
                infobox_content.push('<div class="mapviwe-img">');
                    ...
                    if (
                        ...
                        infobox_content.push('<img title="' + property.item.address_short + ', ' + property.item.address_large + '" alt="' + property.item.address_short + ', ' + property.item.address_large + '" src="' + property.item.gallery[0] + '"><img src="'+__flex_g_settings.board_info.board_logo_url+'" style="position: absolute;bottom: 10px;z-index: 2;width: 80px;right: 10px;height:auto">');
                    }else{
