...
function idx_off_market_listing_slider_html(info_item, type) {
	...
	html_response.push('<h2 title="' + info_item.address + '" class="ms-property-address">' + info_item.address + '</h2>');

	html_response.push('<ul class="features">');
	html_response.push('<li class="address">' + info_item.address + '</li>');
	html_response.push('<li class="price">' + info_item.property_title + '</li>');
