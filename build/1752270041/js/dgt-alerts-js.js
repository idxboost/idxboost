...
$(function() {    
    // code...
        ...
        jQuery('#modal_subscribe .close').click(function(){
            jQuery('html').removeClass('active_modal modal_mobile');
            jQuery('#modal_subscribe').removeClass('active_modal');                
        });    
    ...
    jQuery('.form_submit_button_search_desuscribe').click(function(event) {
            ...
            success: function(data) {
                ...
                jQuery('#modal_subscribe').addClass('active_modal');                
            }
        });
    });
    ...
    jQuery('#input_update_name_search_token').change(function(){
        jQuery('.idxboost_edit_info_alert span').text(jQuery(this).val());
    });
    ...
    jQuery('.modal_cm .close').click(function(){
        ...
        $("#form-update-alert-for-token").on("submit", function(event) {
            ...
            success: function(data) {
                ...
                jQuery(".idxboost_edit_info_alert").show().ready(function(){ jQuery('.idxboost_subscribe').hide(); });
