...
function get_listings(){	
	...
	var payload = {
	            ...
	            'board_id' : __flex_rs_filter.board_id,
		...
		ajax_request_filter=$.ajax({
			...
			type: "POST",
			contentType: (__flex_g_settings.version == "1" ? "application/json" : "application/x-www-form-urlencoded" ),
			"data": payload,		
			dataType: "json",
		...
		return function() {
			if (property.group.length > 1) {
                ...
                if (
                    	...
                    	infobox_content.push('<img title="' + property_group.address_short.replace(/# /, "#") + ', ' + property_group.address_large.replace(/ , /, ", ") + '" alt="' + property_group.address_short.replace(/# /, "#") + ', ' + property_group.address_large.replace(/ , /, ", ") + '" src="' + (__flex_g_settings.version == "1" ? property_group.thumbnail_url : property_group.image_url )  + '"><img src="'+__flex_g_settings.board_info.board_logo_url+'" style="position: absolute;bottom: 10px;z-index: 2;width: 80px;right: 10px;height:auto">');
                    }else{
                        infobox_content.push('<img title="' + property_group.address_short.replace(/# /, "#") + ', ' + property_group.address_large.replace(/ , /, ", ") + '" alt="' + property_group.address_short.replace(/# /, "#") + ', ' + property_group.address_large.replace(/ , /, ", ") + '" src="' + (__flex_g_settings.version == "1" ? property_group.thumbnail_url : property_group.image_url ) + '">');
                    }
                ...
                if (
                    	...
                    	infobox_content.push('<img title="' + property.item.address_short.replace(/# /, "#") + ', ' + property.item.address_large.replace(/ , /, ", ") + '" alt="' + property.item.address_short.replace(/# /, "#") + ', ' + property.item.address_large.replace(/ , /, ", ") + '" src="' + (__flex_g_settings.version == "1" ? property.item.thumbnail_url : property.item.image_url )  + '"><img src="'+__flex_g_settings.board_info.board_logo_url+'" style="position: absolute;bottom: 10px;z-index: 2;width: 80px;right: 10px;height:auto">');
                    }else{
                        infobox_content.push('<img title="' + property.item.address_short.replace(/# /, "#") + ', ' + property.item.address_large.replace(/ , /, ", ") + '" alt="' + property.item.address_short.replace(/# /, "#") + ', ' + property.item.address_large.replace(/ , /, ", ") + '" src="' + (__flex_g_settings.version == "1" ? property.item.thumbnail_url : property.item.image_url ) + '">');
                    }
