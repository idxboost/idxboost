...
var paginationHTML=[];
                if (totpag > 1) {
                    ...
                    if (urlpageante && totpag > 1) {
                        paginationHTML.push('<a role="button" data-page="0" title="First Page" id="firstp" class="ad visible pagfilajax">');
                    ...
                    if (pag_fil) {
                        paginationHTML.push('<a role="button" data-page="' + (parseInt(pag_fil) - 1) + '" title="Prev Page" id="prevn" class="arrow clidxboost-icon-arrow-select prevn visible pagfilajax">');
                      ...
                      for (var i = 0 , l = 5 ; i <= l; i++) {
                        ...
                        if (loopPage>0) {
                          if (parseInt(pag_fil+1) === loopPage) {
                              paginationHTML.push('<li class="active"><a role="button" class="pagfilajax" data-page="' +(loopPage-1)+ '">' + loopPage+ '</a></li>');
                          } else {
                              paginationHTML.push('<li><a role="button" class="pagfilajax" data-page="' + (loopPage-1) + '">' + loopPage + '</a></li>');
                          }
                        }
                     }
                    }else{
                    ...
                    if (pag_filnext)  {
                        paginationHTML.push('<a role="button" data-page="' + pag_filnext + '" title="Prev Page" id="nextn" class="arrow clidxboost-icon-arrow-select nextn visible pagfilajax">');
                        paginationHTML.push('<span>Next page</span>');
                        paginationHTML.push('</a>');
                    }
                      if (pag_filnext && totpag > 1) {
                        paginationHTML.push('<a role="button" data-page="' + (totpag-1) + '" title="End Page" id="lastp" class="ad visible pagfilajax">');
                        paginationHTML.push('<span class="clidxboost-icon-arrow-select"></span>');
                        paginationHTML.push('<span class="clidxboost-icon-arrow-select"></span>');
