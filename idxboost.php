...
define('FLEX_IDX_IA_CPANEL_URL', 'https://api-ia.idxboost.dev');
...
define('IDXBOOST_CRM', 'https://crm-1ycrqzh4ek.idxboost.app');
 ...
 * API endpoints
 */
define('FLEX_IDX_API_SEARCH_FILTER_V2','https://api-idx-search.idxboost.com');
define('FLEX_IDX_API_NEW_DEVELOPMENT_DETAIL','https://api-developments.idxboost.com');
define('FLEX_IDX_API_COLLECTIONS','https://api-collections.idxboost.com');
...
define('FLEX_IDX_API_MARKET_EXCLUSIVE_LISTINGS_v2', FLEX_IDX_BASE_URL . '/v2/listings/exclusive');
define('FLEX_IDX_API_MARKET_RECENT_SALE_v2', FLEX_IDX_BASE_URL . '/v2/listings/recentsales');
...
define('FLEX_IDX_API_PROPERTY_DETAIL_EXTRA', FLEX_IDX_BASE_URL . '/listing/extra_data');
...
define('FLEX_IDX_API_LEADS_AUTOLOGIN', FLEX_IDX_BASE_URL . '/leads/email/autologin');
...
define('FLEX_IDX_API_MARKET_AGENT_OFFICE_LISTINGS_V2_ELASTIC', FLEX_IDX_API_SEARCH_FILTER_V2 . '/listings/agent_office');
