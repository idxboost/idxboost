               ...
               <div class="container">
                ...
                <ul class="property-information" data-inf="price:<?php echo isset($property['is_sold']) ? $property['price_sold'] : $property['price']; ?>|beds:<?php echo $property['bed']; ?>|baths:<?php echo $property['bath']; ?>|sqft:<?php echo $property['sqft']; ?>">
                  <li class="price-property">
                    ...
                    <div class="ib-pipasking">
                      <div class="ib-pipatxt -mobile js-est-payment"><?php echo __("Est. Payment", IDXBOOST_DOMAIN_THEME_LANG); ?><button class="ib-price-calculator show-modal ico-calculator" data-modal="modal_calculator" id="calculator-mortgage" data-price="$<?php echo number_format($property['price']); ?>"></button></div>
                    </div>
                  <?php } ?>
                  </li>
                  ...
                  <li class="btn-save">
                    ...
                    <button class="chk_save chk_save_property dgt-mark-favorite" data-address="<?php echo $property['address_short']; ?>" data-alert-token="<?php echo $property['token_alert']; ?>" data-mls="<?php echo $property['mls_num']; ?>" data-class-id="<?php echo $property['class_id']; ?>">
                      ...
                      <span class="ib-piltxt -min active"><?php echo __("Remove", IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                    </button>
                    <?php else: ?>
                    <button class="chk_save chk_save_property dgt-mark-favorite" data-address="<?php echo $property['address_short']; ?>" data-mls="<?php echo $property['mls_num']; ?>" data-class-id="<?php echo $property['class_id']; ?>">
                      <span class="ib-piltxt"><?php echo __("Save favorite", IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                      <span class="ib-piltxt -min"><?php echo __("Save", IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                    </button>
                    <?php endif;?>
                  </li>
                  <?php endif; ?>
                          ...
                          <div class="ib-plist-card">
                            ...
                            <ul class="ib-plist-list">
                              ...
                              <li>
                                 ...
                                 <span class="ib-plist-pt"><?php echo $property['sqft']; ?></span>
                              </li>
                        ...
                        <div class="ib-plist-card">
                           <h2 class="ib-plist-card-title"><?php echo __("Interior Features", IDXBOOST_DOMAIN_THEME_LANG); ?></h2>
                                    <ul class="ib-plist-list">
                                       ...
                                       <?php } ?>
                                       <li>
                                          <span class="ib-plist-st">Sq Ft Total</span>
                                          <span class="ib-plist-pt"><?php echo number_format($property["sqft"]); ?></span>
                                       </li>
                                    </ul>
                        </div>
                        <div class="ib-plist-card">
                           <h2 class="ib-plist-card-title"><?php echo __("Property Features", IDXBOOST_DOMAIN_THEME_LANG); ?></h2>
                                    <ul class="ib-plist-list">
                                       ...
                                       <li>
                                          <span class="ib-plist-st">Tax Information</span>
