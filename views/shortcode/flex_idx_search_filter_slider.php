...
<form id="flex_idx_search_filter_form" method="post">
    ...
    <input type="hidden" name="rect"
           value="<?php echo isset($_GET["rect"]) ? sanitize_text_field($_GET["rect"]) : ''; ?>">
...
<div id="flex_idx_search_filter" data-filter-id="<?php echo $atts['id']; ?>"
     class="ib-mapgrid-container ib-vgrid-active" style="display:none !important;">
        ...
        <div class="idx-btn-content">
          ...
          <span><?php echo __('Remove', IDXBOOST_DOMAIN_THEME_LANG); ?> <br> <?php echo __('Boundaries', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                ...
                <button class="idx-btn-act ib-show ib-removeb-tg ib-removeb-hide"
                        aria-label="<?php echo __("Search this area", IDXBOOST_DOMAIN_THEME_LANG); ?>">
                    <span><?php echo __("Search this area", IDXBOOST_DOMAIN_THEME_LANG); ?></span></button>
            </div>
        </div>
    </div>
    <div class="ib-wmap">
        <div id="wrap-map-draw-actions" style="display:none;">
            ...
            <div class="flex-content-btn-draw">
                <button type="button"
                        id="map-draw-cancel-tg"><?php echo __('Cancel', IDXBOOST_DOMAIN_THEME_LANG); ?></button>
                <button type="button"
                        id="map-draw-apply-tg"><?php echo __('Apply', IDXBOOST_DOMAIN_THEME_LANG); ?></button>
            </div>
        </div>
    ...
    <div class="ib-wgrid">
                ...
                <div class="ib-gmfilters">
                    <div class="ib-gwsort">
                        <label class="ms-hidden"
                               for="ib-gsort-b"><?php echo __('Select option', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
        ...
        <div class="ib-gnopro">
            ...
            <span class="ib-rembounds"
                  style="color:blue;font-weight:600;cursor:pointer;">Search this area</span> <?php echo __('or modify your', IDXBOOST_DOMAIN_THEME_LANG); ?>
            <span class="ib-gnpoall"><?php echo __('filter', IDXBOOST_DOMAIN_THEME_LANG); ?></span> <?php echo __('preferences to get new results or', IDXBOOST_DOMAIN_THEME_LANG); ?>
                    ...
                    <form method="post" class="ib-property-mortgage-f">
                        <ul class="ib-mcinputs">
                            <li class="ib-mcitem"><span
                                        class="ib-mgitxt"><?php echo __('Purchase Price', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                                <div class="ib-mgiwrapper ib-property-mc-pp">
                                    <label class="ms-hidden"
                                           for="ib-property-mc-pp"><?php echo __('Purchase Price', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                                    <input id="ib-property-mc-pp" class="ib-mcipurchase ib-property-mc-pp" value=""
                                           type="text" readonly>
                                </div>
                            </li>
                            <li class="ib-mcitem"><span
                                        class="ib-mgitxt"><?php echo __('Year Term', IDXBOOST_DOMAIN_THEME_LANG); ?> (<?php echo __('Years', IDXBOOST_DOMAIN_THEME_LANG); ?>)</span>
                                <div class="ib-mgiwrapper ib-mgwselect">
                                    <label class="ms-hidden"
                                           for="ib-property-mc-ty"><?php echo __('Select year', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                                    ...
                                    <div class="ms-wrapper-dropdown-menu">
                                        ...
                                        <ul id="calculatorYearsList" class="ms-dropdown-menu" role="menu">
                                            <li><a role="button" data-value="30"
                                                   class="-js-item-cl"><?php echo __('30 Years', IDXBOOST_DOMAIN_THEME_LANG); ?></a>
                                            </li>
                                            <li><a role="button" data-value="20"
                                                   class="-js-item-cl"><?php echo __('20 Years', IDXBOOST_DOMAIN_THEME_LANG); ?></a>
                                            </li>
                                            <li><a role="button" data-value="15"
                                                   class="-js-item-cl"><?php echo __('15 Years', IDXBOOST_DOMAIN_THEME_LANG); ?></a>
                                            </li>
                                            <li><a role="button" data-value="10"
                                                   class="-js-item-cl"><?php echo __('10 Years', IDXBOOST_DOMAIN_THEME_LANG); ?></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <li class="ib-mcitem"><span
                                        class="ib-mgitxt"><?php echo __('Interest Rate(%)', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                                <div class="ib-mgiwrapper">
                                    <label class="ms-hidden"
                                           for="ib-property-mc-ir"><?php echo __('Interest Rate(%)', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                            ...
                            <li class="ib-mcitem"><span
                                        class="ib-mgitxt"><?php echo __('Down Payment(%)', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                                <div class="ib-mgiwrapper">
                                    <label class="ms-hidden"
                                           for="ib-property-mc-dp"><?php echo __('Down Payment(%)', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                                    <div class="ms-item-input">
                        ...
                        <button type="button"
                                class="ib-mgsubmit ib-property-mortage-submit"><?php echo __('Calculate', IDXBOOST_DOMAIN_THEME_LANG); ?></button>
                    </form>
                </div>
                <div class="mb-mcdata">
                    <p><?php echo __("Let's us know the best time for showing.", IDXBOOST_DOMAIN_THEME_LANG); ?> <a
                                href="tel:<?php echo preg_replace('/[^\d]/', '', $flex_idx_info['agent']['agent_contact_phone_number']); ?>"
                                title="Call Us <?php echo flex_agent_format_phone_number(preg_replace('/[^\d]/', '', $flex_idx_info['agent']['agent_contact_phone_number'])); ?>"><?php echo flex_agent_format_phone_number(preg_replace('/[^\d]/', '', $flex_idx_info['agent']['agent_contact_phone_number'])); ?></a>
                    </p>
                </div>
            </div>
            <div class="ib-img-calculator"></div>
        </div>
        <div class="ib-mmclose"><span class="ib-mmctxt"><?php echo __('Close', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
        </div>
    </div>
        ...
        <div class="ib-mwrapper ib-mgeneric">
            ...
            <form method="post" class="ib-property-share-friend-f iboost-secured-recaptcha-form">
                ...
                <div class="ib-mgcontent"><?php echo __('Recommend this to a friend, just enter their email below.', IDXBOOST_DOMAIN_THEME_LANG); ?>
                    <div class="ib-meblock"><span
                                class="ib-mgitxt"><?php echo __('Friend&#039s Email*', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                        <div class="ib-mgiwrapper">
                            <label class="ms-hidden"
                                   for="friend_email"><?php echo __('Friend&#039s Email*', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                            <input id="friend_email" class="ib-meinput" name="friend_email" type="email"
                                   placeholder="<?php echo __('Friend&#039s Email*', IDXBOOST_DOMAIN_THEME_LANG); ?>"
                                   value="" required>
                        </div>
                        <div class="ib-mgiwrapper">
                            <label class="ms-hidden"
                                   for="friend_name"><?php echo __('Friend&#039s Name*', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                            <input id="friend_name" class="ib-meinput" name="friend_name" type="text"
                                   placeholder="<?php echo __('Friend&#039s Name*', IDXBOOST_DOMAIN_THEME_LANG); ?>"
                                   value="" required>
                        </div>
                    </div>
                    <div class="ib-meblock"><span
                                class="ib-mgitxt"><?php echo __('Your Information', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                        <div class="ib-mgiwrapper">
                            <label class="ms-hidden"
                                   for="_sf_name"><?php echo __('Your Name*', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                            <input class="ib-meinput" id="_sf_name" name="your_name" type="text"
                                   placeholder="<?php echo __('Your Name*', IDXBOOST_DOMAIN_THEME_LANG); ?>" value=""
                                   required>
                        </div>
                        <div class="ib-mgiwrapper">
                            <label class="ms-hidden"
                                   for="_sf_email"><?php echo __('Your Email*', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                            <input class="ib-meinput" id="_sf_email" name="your_email" type="email"
                                   placeholder="<?php echo __('Your Email*', IDXBOOST_DOMAIN_THEME_LANG); ?>" value=""
                                   required>
                        </div>
                        <div class="ib-mgiwrapper ib-mgtextarea">
                            <label class="ms-hidden"
                                   for="ib-metextarea"><?php echo __('Comments*', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                            <textarea class="ib-metextarea" name="comments" type="text"
                    ...
                    <button type="submit"
                            class="ib-mgsubmit"><?php echo __('Submit', IDXBOOST_DOMAIN_THEME_LANG); ?></button>
                </div>
            </form>
        </div>
        <div class="ib-mmclose" role="button" aria-label="<?php echo __('Close', IDXBOOST_DOMAIN_THEME_LANG); ?>"><span
                    class="ib-mmctxt"><?php echo __('Close', IDXBOOST_DOMAIN_THEME_LANG); ?></span></div>
    </div>
    <div class="ib-mmbg"></div>
</div>
...
<div class="ib-modal-master" data-id="submit" id="ib-email-thankyou">
    <div class="ib-mmcontent">
        <div class="ib-mgeneric ib-msubmit"><span
                    class="ib-mssent ib-mstxt ib-icon-check"><?php echo __('Email Sent!', IDXBOOST_DOMAIN_THEME_LANG); ?> </span><span
                    class="ib-mssucces ib-mstxt"><?php echo __('Your email was sent successfully', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
        </div>
                ...
                <form method="post" class="flex-save-search-modals">
                    <ul class="ib-msavesearch">
                        <li class="ib-mssitem"><span
                                    class="ib-mssitxt"><?php echo __('Name your search', IDXBOOST_DOMAIN_THEME_LANG); ?>*</span>
                            <div class="ib-mgiwrapper">
                                <label class="ms-hidden"
                                       for="ib-name-search-a"><?php echo __('Name your search', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                                <input class="ib-mssinput ib-name_search" name="search_name" type="text"
                                       placeholder="<?php echo __('Name your search', IDXBOOST_DOMAIN_THEME_LANG); ?>"
                                       id="ib-name-search-a">
                            </div>
                        </li>
                        <li class="ib-mssitem"><span
                                    class="ib-mssitxt"><?php echo __('Email Updates', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                            <div class="ib-mgiwrapper ib-mgwselect">
                                <label class="ms-hidden"
                                       for="ib-mgwselect-a"><?php echo __('Email Updates', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                                <select class="ib-mssselect" name="notification_day" id="ib-mgwselect-a">
                                    <option value="--"><?php echo __('No Alert', IDXBOOST_DOMAIN_THEME_LANG); ?></option>
                                    <option value="1"
                                            selected=""><?php echo __('Daily', IDXBOOST_DOMAIN_THEME_LANG); ?></option>
                        ...
                        <li class="ib-mssitem"><span
                                    class="ib-mssitxt"><?php echo __('Only Update me On', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                            <ul class="ib-mssupdate">
                                <li class="ib-mssuitem">
                                    ...
                                    <label class="ib-msslabel"
                                           for="ib-check-new-listing"><?php echo __('New Listing (Always)', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                                </li>
                                <li class="ib-mssuitem">
                                    <input class="ib-msscheckbox" type="checkbox" id="ib-check-price-change"
                                           name="notification_type[]" value="price_change" checked>
                                    <label class="ib-msslabel"
                                           for="ib-check-price-change"><?php echo __('Price Change', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                                </li>
                                <li class="ib-mssuitem">
                                    <input class="ib-msscheckbox" type="checkbox" id="ib-check-status-change"
                                           name="notification_type[]" value="status_change" checked>
                                    <label class="ib-msslabel"
                                           for="ib-check-status-change"><?php echo __('Status Change', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                                </li>
                            </ul>
                        </li>
                    </ul>
            ...
            <article class="ib-property-detail ib-pdmodal">
                <div class="ib-pcheader">
                    <div class="ib-pwheader">
                        <header class="ib-pheader">
                            <h2 class="ib-ptitle">{{address_short}}</h2><span
                                    class="ib-pstitle">{{address_large}}</span>
                        </header>
                        <div class="ib-phcta">
                            <div class="ib-phomodal">
                                <a href="tel:<?php echo $idx_contact_phone; ?>" class="ib-pbtnphone">{{agentPhone
                                    this}}</a>
                                    ...
                                    <div class="ms-wrapper">
                                        ...
                                        <ul class="ms-share-list">
                                            <li class="ib-pscitem ib-psemailfriend" data-status="{{status_type}}"
                                                data-mls="{{mls_num}}" data-permalink="" data-lg="{{lng}}"
                                                data-lt="{{lat}}">
                                                <a role="button" class="ib-psbtn"
                                                   aria-label="Email to a friend"><?php echo __("Email to a friend", IDXBOOST_DOMAIN_THEME_LANG); ?></a>
                                            </li>
                                            <li><a role="button"
                                            ...
                                            <li><a href="{{ propertyPermalink slug }}" class="ib-plsitem ib-plsitw"
                                                   ...
                                                   data-rental="{{is_rental}}" data-mls="{{mls_num}}">Twitter</a></li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <a href="{{ propertyPermalink slug }}" class="ib-phbtn -order" target="_blank"><i
                                            class="idx-icon-open"></i> <?php echo __("Open", IDXBOOST_DOMAIN_THEME_LANG); ?>
                                </a>
                ...
                <div class="ib-pcontent">
                    <div class="ib-pviews {{ markClassActiveTab this }}">
                        <div class="ib-pvwcta">
                            <ul class="ib-pvcta">
                                <li class="ib-pvitem {{ markPhotosActive this }}"
                                    data-id="photos"><?php echo __("Photos", IDXBOOST_DOMAIN_THEME_LANG); ?></li>
                                <li class="ib-pvitem {{ markMapActive this }}" data-id="map" data-loaded="no"
                                    data-lat="{{lat}}" data-lng="{{lng}}"
                                    data-><?php echo __("Map View", IDXBOOST_DOMAIN_THEME_LANG); ?></li>
                                {{#if virtual_tour}}
                                <li class="ib-pvitem" data-id="video">
                                    <a class="ib-plvideo" href="{{virtual_tour}}" title="Video" target="_blank"
                                       rel="nofollow"><?php echo __("Video", IDXBOOST_DOMAIN_THEME_LANG); ?></a>
                                </li>
                                {{/if}}
                            </ul>
                    ...
                    <div class="ib-pbia">
                        <div class="ib-pwinfo">
                            <div class="ib-pinfo">
                                ...
                                <div class="ms-sf-view-actions" style="z-index:3; top: 70px">
                                        ...
                                        <div class="ms-wrapper">
                                            ...
                                            <ul class="ms-share-list">
                                                <li class="ib-pscitem ib-psemailfriend -emailtofriendbuilding"
                                                    data-permalink="" data-mls="<?php echo $property["mls_num"]; ?>"
                                                    data-status="">
                                    ...
                                    <a href="tel:<?php echo preg_replace('/[^\d]/', '', $idx_contact_phone); ?>"
                                ...
                                <div class="ib-pilf">
                                    ...
                                    <ul class="ib-pilist">
                                        <li class="ib-pilitem ib-pilprice">
                                            ...
                                            <div class="ib-pipasking">
                                                ...
                                                <div class="ib-pipatxt -mobile js-est-payment"><?php echo __("Est. Payment", IDXBOOST_DOMAIN_THEME_LANG); ?>
                                                    <button class="ib-price-calculator"></button>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="ib-pilitem ib-pilbeds"><span class="ib-pilnumber">{{bed}}</span><span
                                                    class="ib-piltxt"><?php echo __("Bedroom(s)", IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                                        ...
                                        <li class="ib-pilitem ib-pilbaths"><span
                                                    ...
                                                    class="ib-piltxt"><?php echo __("Bathroom(s)", IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                                        ...
                                        <li class="ib-pilitem ib-pilhbaths ms-hidden-mb"><span class="ib-pilnumber">{{baths_half}}</span><span
                                                    class="ib-piltxt"><?php echo __("Half Bath(s)", IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                                      ...
                                      {{/if}}                                      
                                        ...
                                        <li class="ib-pilitem ib-pilsize ms-hidden-pc"><span class="ib-pilnumber">{{price_sqft}}</span><span
                                                    class="ib-piltxt"><?php echo __("$/Sqft", IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                                    ...
                                    <div class="ms-wrapper-btn-new-share">
                                        <div class="ms-wrapper">
                                            <button class="ms-share-btn"><?php echo __("Share", IDXBOOST_DOMAIN_THEME_LANG); ?></button>
                                            <ul class="ms-share-list">
                                                <li class="ib-pscitem ib-psemailfriend" data-status="Active"
                                                    data-mls="A11132797" data-permalink="">
                                                    <a role="button" class="ib-psbtn" aria-label="Email to a friend">Email
                                                        to a friend</a>
                                                </li>
                                                <li><a role="button"
                                                       class="ib-pllink -clipboard"><?php echo __("Copy Link", IDXBOOST_DOMAIN_THEME_LANG); ?>
                                ...
                                <ul class="ib-psc" style="display: none">
                                    <li class="ib-pscitem ib-pshared">
                                        <div class="ib-psbtn"><span
                                                    class="ib-pstxt"><?php echo __("Share", IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                                        </div>
                                    ...
                                    <li class="ib-pscitem ib-pscalculator" data-price="{{price}}">
                                        <button class="ib-psbtn" aria-label="Mortgage"><span
                                                    class="ib-pstxt"><?php echo __("Mortgage", IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                                        </button>
                                    </li>
                                    <li class="ib-pscitem ib-psemailfriend" data-status="{{status_type}}"
                                        data-mls="{{mls_num}}" data-permalink="">
                                        <button class="ib-psbtn" aria-label="Email to a friend"><span
                                                    class="ib-pstxt"><?php echo __("Email to a friend", IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                                        </button>
                                    </li>
                                    <li class="ib-pscitem ib-psprint">
                                        <button class="ib-psbtn" aria-label="Print"><span
                                                    class="ib-pstxt"><?php echo __("print", IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                                        </button>
                                    </li>
                                </ul>
                                ...
                                <?php if (in_array($flex_idx_info["board_id"], [31, 33])) { ?>
                                    <div class="ib-pdescription-title"
                                         style="display: block !important;position: relative;font-size: 14px;padding: 15px 15px 0 15px;margin-bottom: 0;border-bottom: 1px dashed #ccc;padding-bottom: 15px;font-weight: normal; color: #858585; order:3">
                                        Listing provided courtesy of {{office_name}}
                                    </div>
                                <?php } ?>
                                ...
                                <div class="ib-pablock ib-bsproperties">
                                    ...
                                    <ul class="ib-sproperties">
                                        ...
                                        <li class="ib-spitem ib-rel-property" data-mls="{{mls_num}}">
                                            <div class="ib-spipa">
                                                ...
                                                <ul class="ib-spdetails">
                                                    ...
                                                    <li class="ib-spditem ib-spbeds"><span
                                                                class="ib-spdbold">{{bed}}</span> <?php echo __("Bed(s)", IDXBOOST_DOMAIN_THEME_LANG); ?>
                                                    </li>
                                                    <li class="ib-spditem ib-spbaths"><span
                                                                class="ib-spdbold">{{bath}}</span> <?php echo __("Bath(s)", IDXBOOST_DOMAIN_THEME_LANG); ?>
                                                    </li>
                                                    <li class="ib-spditem ib-spsqft"><span class="ib-spdbold">{{ formatSqft sqft }}</span> <?php echo __("Sqft", IDXBOOST_DOMAIN_THEME_LANG); ?>
                                                    </li>
                                                    <li class="ib-spditem ib-spsqft"><span class="ib-spdbold">${{ formatPriceSqft this }}</span>
                                                        / <?php echo __("Sqft", IDXBOOST_DOMAIN_THEME_LANG); ?></li>
                                                    <?php if (in_array($flex_idx_info["board_id"], ["31"])) { ?>
                                                        <li class="ib-ibditem ms-small-text"
                                                            style="font-size: 11px;margin-top: 3px;width: 100%;"><?php echo __("Listing Provided by NWMLS", IDXBOOST_DOMAIN_THEME_LANG); ?></li>
                                                    <?php } ?>
                                                </ul>
                                            </div>
                                            <div class="ib-spipb">
                                            ...
                                            <?php if (in_array($flex_idx_info["board_id"], ["31"])) { ?>
                                                <img src="https://idxboost-spw-assets.idxboost.us/logos/nwmls.jpg"
                                                     style="position: absolute;top: 5px;right: 5px;width: 45px;">
                                            <?php } ?>
                                            <a class="ib-splink" role="button"
                                               title="<?php echo __("Details of", IDXBOOST_DOMAIN_THEME_LANG); ?> {{address_short}} {{address_large}}">
                            ...
                            <div class="ib-bdisclaimer ib-bdisclaimer-desktop">
                                ...
                                <?php } else { ?>
                                    <p>
                                        ...
                                        &copy;<?php echo date('Y'); ?>
                                        -<?php echo __("present", IDXBOOST_DOMAIN_THEME_LANG); ?> {{board_name}}®.
                                ...
                                <div class="ib-pacftitle">
                                    ...
                                    <div class="ib-cftpb">
                                        ...
                                        <a class="ib-cftphone" href="tel:{{agentPhoneNumber this}}"
                                           title="<?php echo __("Call to", IDXBOOST_DOMAIN_THEME_LANG); ?> {{agentPhone this}}"><?php echo __("Ph", IDXBOOST_DOMAIN_THEME_LANG); ?>
                                            . {{agentPhone this}}</a>
                                    </div>
                                </div>
                                <div class="ib-pacform">
                                    <form class="ib-cform ib-propery-inquiry-f gtm_more_info_property iboost-form-validation"
                                        ...
                                        <ul class="ib-cffields">
                                            ...
                                            <li class="ib-cffitem">
                                                <textarea class="ib-cftextarea" name="message" type="text"
                                                          placeholder="<?php echo __("Comments", IDXBOOST_DOMAIN_THEME_LANG); ?>"
                                                          required><?php echo __("I am interested in", IDXBOOST_DOMAIN_THEME_LANG); ?> {{address_short}} {{address_large}}</textarea>
                                            </li>
                                        </ul>
                                        ...
                                        <div class="ib-cfrequired">
                                            * <?php echo __("Required fields", IDXBOOST_DOMAIN_THEME_LANG); ?></div>
                        ...
                        <div class="ib-bdisclaimer ib-bdisclaimer-mobile">
                            ...
                            <?php } ?>
                            <?php if (array_key_exists('board_info', $property) && array_key_exists("board_disclaimer", $property['board_info']) && !empty($property['board_info']["board_disclaimer"])) { ?>
                                <p><?php $disclaimer = str_replace('{officeName}', $flex_idx_info["office_name"], $flex_idx_info['board_info']["board_disclaimer"]);
                                    echo $disclaimer; ?> <a class="ib-phone-office" href="tel:{{phone_office}}">Ph.{{phone_office}}</a>
                                </p>
                            <?php } else { ?>
                                <p>
                                    <?php echo __("The multiple listing information is provided by the", IDXBOOST_DOMAIN_THEME_LANG); ?>
    ...
    <li class="ib-pitem" data-geocode="{{ lat }}:{{ lng }}" data-mls="{{ mls_num }}" data-status="{{ status }}">
        <ul class="ib-piinfo">
            ...
            <li class="ib-piitem ib-pibaths">{{ bath }}{{ formatBathsHalf baths_half
                }} <?php echo __('Bath(s)', IDXBOOST_DOMAIN_THEME_LANG); ?></li>
            <li class="ib-piitem ib-pisqft">{{ formatSqft sqft
                }} <?php echo __('Sq.Ft.', IDXBOOST_DOMAIN_THEME_LANG); ?></li>
            <li class="ib-piitem ib-paddress">{{ full_address }}</li>
            <?php if (in_array($flex_idx_info["board_id"], ["31"])) { ?>
                <li class="ib-piitem ib-small-text ms-ellipsis-dm" style="font-size: 12px;margin-top: 5px;">Listing
                    Provided by NWMLS
                </li>
            <?php } ?>
        ...
        <a class="ib-pipermalink" href="{{ idxPermalink this }}"
           title="<?php echo __('View Detail of', IDXBOOST_DOMAIN_THEME_LANG); ?> {{ full_address }}"><span>{{ full_address }}</span></a>
    </li>
...
<div class="ib-modal-filters-mobile" style="display:none;">
    <div class="ib-content-modal-filters-mobile">
      ...
      <?php endif; ?>-->
            ...
            <button class="ib-close-modal-filters-mobile"
                    aria-label="<?php echo __('Close', IDXBOOST_DOMAIN_THEME_LANG); ?>">
                <span><?php echo __('Close', IDXBOOST_DOMAIN_THEME_LANG); ?></span></button>
        </div>
        <!--Boby modal-->
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-min-price"><?php echo __('Select option', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                            ...
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-max-price"><?php echo __('Select option', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                ...
                <div class="ib-item-collapse ib-item-collapse-saletype ib-item-collapse-rent" style="display:none;">
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-min-rent-price"><?php echo __('Select option', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                            ...
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-max-rent-price"><?php echo __('Select option', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                ...
                <div id="ib-bedrooms-collapse" class="ib-item-collapse">
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-min-beds"><?php echo __('Select option', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                            ...
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-max-beds"><?php echo __('Select option', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                ...
                <div class="ib-item-collapse">
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-min-baths"><?php echo __('Select option', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                            ...
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-max-baths"><?php echo __('Select option', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                ...
                <div class="ib-item-collapse">
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-min-living"><?php echo __('Select option', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                            ...
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-max-living"><?php echo __('Select option', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                ...
                <div class="ib-item-collapse">
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-min-land"><?php echo __('Select option', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                            ...
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-max-land"><?php echo __('Select option', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                ...
                <div class="ib-item-collapse">
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-min-year"><?php echo __('Select option', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                            ...
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-max-year"><?php echo __('Select option', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                ...
                <div class="ib-item-collapse">
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-flex-waterfront-switch"><?php echo __('Select option', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
        ...
        <div class="ib-footer-modal-filters-mobile">
            <div class="ib-group-buttons-content">
                <button id="ib-apply-clear"><?php echo __('Clear', IDXBOOST_DOMAIN_THEME_LANG); ?></button>
                <button id="ib-apply-filters-btn"><?php echo __('View', IDXBOOST_DOMAIN_THEME_LANG); ?>
                    <span>0 </span><?php echo __('Properties', IDXBOOST_DOMAIN_THEME_LANG); ?></button>
            </div>
        </div>
    </div>
</div>
...
<section data-limit="<?php echo $atts["limit"]; ?>" data-gallery="<?php echo $atts['gallery']; ?>"
         data-item="<?php echo $atts['slider_item']; ?>"
         class="flex-block-description mtop-60 ib-filter-slider ib-filter-slider-2 featured-section js-slider-filter-search"
         data-filter="2" id="featured-section">
    ...
    <div class="wrap-result view-grid">
        ...
        <div class="gs-container-slider ib-properties-slider"
             id="search-filter-slider-<?php echo $atts['id']; ?>"></div>
    </div>
</section>
<script>
