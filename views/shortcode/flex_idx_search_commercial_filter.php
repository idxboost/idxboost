...
<?php include FLEX_IDX_PATH . '/views/shortcode/flex_idx_search_commercial_filter_bar.php';  ?>
            ...
            <ul class="ib-mcinputs">
              <li class="ib-mcitem">
                ...
                <div class="ib-mgiwrapper">
                  <label for="ib-mcipurchase" class="ms-hidden"><?php echo __('Purchase Price', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
              ...
              <li class="ib-mcitem">
                ...
                <div class="ib-mgiwrapper">
                  <label for="ib-property-mc-dp" class="ms-hidden"><?php echo __('% Down Payment', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                  <input id="ib-property-mc-dp" class="ib-mcidpayment ib-property-mc-dp" value="30" step="any" type="number" max="95" min="0">
                </div>
              </li>
              <li class="ib-mcitem">
                <span class="ib-mgitxt"><?php echo __('Term', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                <div class="ib-mgiwrapper ib-mgwselect">
                  <label class="ms-hidden" for="ib-mcsyears ib-property-mc-ty"><?php echo __('Select option', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
              ...
              <li class="ib-mcitem">
                ...
                <div class="ib-mgiwrapper">
                  <label for="ib-property-mc-ir" class="ms-hidden"><?php echo __('Interest Rate', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
        ...
        <div class="mb-mcdata">
          ...
          <ul class="ib-mcdlist">
            ...
            <li class="ib-mcditem ib-mcdibig">
              <div class="ib-mcditxt"><?php echo __('Total Monthly Amount', IDXBOOST_DOMAIN_THEME_LANG); ?> <span class="ib-mcdibold"><?php echo __('(Principal &amp; Interest, and PMI)', IDXBOOST_DOMAIN_THEME_LANG); ?></span></div>
...
<div class="ib-modal-master" data-id="submit" id="ib-email-thankyou">
  <div class="ib-mmcontent">
    <div class="ib-mgeneric ib-msubmit">
      <span class="ib-mssent ib-mstxt ib-icon-check"><?php echo __('Email Sent!', IDXBOOST_DOMAIN_THEME_LANG); ?> </span>
      <span class="ib-mssucces ib-mstxt"><?php echo __('Your email was sent succesfully', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
    </div>
    <button aria-label="<?php echo __('Close', IDXBOOST_DOMAIN_THEME_LANG); ?>" class="ib-mmclose">
...
<div class="ib-mgiwrapper">
<label class="ms-hidden" for="ib-name_search"><?php echo __('Search Name', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
<input id="ib-name_search" class="ib-mssinput" name="search_name" class="ib-name_search" type="text" placeholder="<?php echo __('Save Search', IDXBOOST_DOMAIN_THEME_LANG); ?>*">
</div>
</li>
                  ...
                  <div class="ib-pwheader">
                      ...
                      <?php if (isset($flex_idx_info["url_logo"]) && !empty($flex_idx_info["url_logo"])) : ?>
                          <div class="ib-logoprint">
                              <img class="ib-logoimg" src="<?php echo $flex_idx_info["url_logo"]; ?>" alt="IDXBoost">
                          </div>
                      <?php endif; ?>
                  </div>
              </div>
                              ...
                              <div class="ib-pacform">
                                  <form class="ib-cform ib-propery-inquiry-f gtm_more_info_property" method="post">
                                      ...
                                      <ul class="ib-cffields">
                                          ...
                                          <li class="ib-cffitem">
  																			<label for="_ib_ln_inq" class="ms-hidden"><?php echo __('Last Name*', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                                          ...
                                          <li class="ib-cffitem">
  																			<label for="ib-cftextarea" class="ms-hidden"><?php echo __('Comments', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
...
<div class="ib-modal-filters-mobile" style="display:none;">
  <div class="ib-content-modal-filters-mobile">
    ...
    <div class="ib-header-modal-filters-mobile">
      ...
      <button class="ib-close-modal-filters-mobile" aria-label="<?php echo __('Close', IDXBOOST_DOMAIN_THEME_LANG); ?>">
      <span><?php echo __('Close', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
      </button>
    </div>
    <!--Boby modal-->
