...
<div id="flex_idx_search_filter" class="ib-mapgrid-container ib-vgrid-active">
    ...
    <div class="ib-wgrid">
        ...
        <div class="ib-gnopro">
            <span class="ib-gnpno"><?php echo __('No matching results...', IDXBOOST_DOMAIN_THEME_LANG); ?></span><?php echo __('Modify your', IDXBOOST_DOMAIN_THEME_LANG); ?>
        ...
        <?php if (in_array($flex_idx_info["board_id"], [33])) { ?>
            <div class="ib-bdisclaimer">
                <img src="https://idxboost-spw-assets.idxboost.us/logos/NYCListingCompliance.jpg"
                     style="width: 110px;height: auto;/* margin-bottom: 5px; */display:inline-block;margin-top: -30px;">
                <?php if ($flex_idx_info["agent"]["restriction_idx"] == "1") { ?>
                    <p><?php echo $flex_idx_info["agent"]["broker_title_associate"]; ?></p>
                <?php } ?>

                <p>The Registrant acknowledges each other RLS Broker’s ownership of, and the validity of their
                    respective copyright in, the Exlusive Listings that are transmitted over the RLS. The information is
                    being provided by REBNY Listing Service, Inc. Information deemed reliable but not guaranteed.
                    Information is provided for consumers’ personal, non-commercial use, and may not be used for any
                    purpose other than the identification of potential properties for purchase. This information is not
                    verified for authenticity or accuracy and is not guaranteed and may not reflect all real estate
                    activity in the market. @<?php echo date('Y'); ?> REBNY Listing Service, Inc. All rights
                    reserved.</p>
            </div>
        <?php } ?>
    </div>
                        ...
                        <div class="ib-pvwcta">
                            <ul class="ib-pvcta">
                                ...
                                <li class="ib-pvitem" data-id="video">
                                    <a rel="nofollow" class="ib-plvideo ms-video-fs" href="{{virtual_tour}}"
                                       data-type="link" title="Virtual Tour"
                                       target="_blank"><?php echo __("Virtual Tour", IDXBOOST_DOMAIN_THEME_LANG); ?></a>
                                </li>
                                {{/if}}
                            </ul>
                    ...
                    <div class="ib-pbia">
                            ...
                            <div class="ib-pinfo">
                                ...
                                <div class="ib-pilf">
                                    ...
                                    <div class="ib-pfavorite {{ idxFavoriteClass this }}" data-mls="{{mls_num}}"
                                        ...
                                        <div class="ib-pftxt -text-min"><?php echo __('Save', IDXBOOST_DOMAIN_THEME_LANG); ?></div>
                                    </div>
                                </div>
                            ...
                            <div class="ib-pablock ib-bcform">
                                ...
                                <div class="ib-pacform">
                                    <form class="ib-cform ib-propery-inquiry-f gtm_more_info_property iboost-form-validation"
                                          method="post">
                                        <?php if (!empty($atts['registration_key'])): ?>
                                            <input type="hidden" name="registration_key"
                                                   value="<?php echo $atts['registration_key']; ?>">
                                        <?php endif; ?>
                        ...
                        <div class="ib-bdisclaimer ib-bdisclaimer-mobile">
                            ...
                            <p>
                                <?php echo __("The multiple listing information is provided by the", IDXBOOST_DOMAIN_THEME_LANG); ?>
                                {{board_name}}® <?php echo __("from a copyrighted compilation of listings. The compilation of listings and each individual listing are", IDXBOOST_DOMAIN_THEME_LANG); ?>
                                &copy;<?php echo date('Y'); ?>-<?php echo __("present", IDXBOOST_DOMAIN_THEME_LANG); ?>
                                {{board_name}}®.
                                <?php echo __("All Rights Reserved. The information provided is for consumers' personal, noncommercial use and may not be used for any purpose other than to identify prospective properties consumers may be interested in purchasing. All properties are subject to prior sale or withdrawal. All information provided is deemed reliable but is not guaranteed accurate, and should be independently verified. Listing courtesy of", IDXBOOST_DOMAIN_THEME_LANG); ?>
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-min-price"><?php echo __('Select a minimum range price', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                            ...
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-max-price"><?php echo __('Select a maximum range price', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                ...
                <div class="ib-item-collapse ib-item-collapse-saletype ib-item-collapse-rent" style="display:none;">
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-min-rent-price"><?php echo __('Select a minimum range price', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                            ...
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-max-rent-price"><?php echo __('Select a maximum range price', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                ...
                <div id="ib-bedrooms-collapse" class="ib-item-collapse">
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-min-beds"><?php echo __('Select a min bedrooms', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                            ...
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-max-beds"><?php echo __('Select a max bedrooms', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                ...
                <div class="ib-item-collapse">
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-min-baths"><?php echo __('Select a min baths', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                            ...
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-max-baths"><?php echo __('Select a max baths', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                ...
                <div class="ib-item-collapse">
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-min-living"><?php echo __('Select min living size', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                            ...
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-max-living"><?php echo __('Select max living size', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                ...
                <div class="ib-item-collapse">
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-min-land"><?php echo __('Select min land size', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                            ...
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-max-land"><?php echo __('Select max land size', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                ...
                <div class="ib-item-collapse">
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-min-year"><?php echo __('Select min year built', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                            ...
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-max-year"><?php echo __('Select max year built', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                ...
                <div class="ib-item-collapse">
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-flex-waterfront-switch"><?php echo $label_waterfront_description; ?></label>
                                ...
                                <ul class="ib-wrap-fm ib-cl-2" id="ib-flex-m-features-extra">
                                    ...
                                    if (count($flex_idx_info["search"]) > 0 && array_key_exists("otherpopularfeatures", $flex_idx_info["search"]) && is_array($flex_idx_info["search"]["otherpopularfeatures"]) &&
                                        ...
                                        foreach ($flex_idx_info["search"]["otherpopularfeatures"] as $keyOther => $valueOther) { ?>
                                            <li class="ib-item-wrap-fm ib-btn-chk-fm">
                                                <input type="checkbox"
                                                       id="ib-amt-extra-inner-amt-mb_<?php echo $keyOther; ?>"
                                                       value="<?php echo $valueOther['code']; ?>"
                                                       class="ib-m-features-checkboxes">
