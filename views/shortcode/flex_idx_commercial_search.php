...
<form id="flex_idx_search_filter_form" method="post">
    <?php if (isset($c_search_settings['idx_listings_type']) && (1 == $c_search_settings['idx_listings_type'])): ?>
        <input type="hidden" name="overwrite_show_hide_pending"
               value="<?php if (isset($c_search_settings['hide_pending_content_options']) && (1 == $c_search_settings['hide_pending_content_options'])): ?>yes<?php else: ?>no<?php endif; ?>">
    <?php endif ?>
        ...
        <?php if (in_array($flex_idx_info["board_id"], [13, 14, 20])) { ?>
            <div class="ib-bdisclaimer">
                ...
                if (isset($flex_idx_info["board_id"]) && ("7" == $flex_idx_info["board_id"])) { ?>
                    <p>The multiple listing information is provided by the Houston Association of Realtors from a
                        copyrighted compilation of listings. The compilation of listings and each individual listing are
                        &copy;<?php echo date('Y'); ?>-present TEXAS All Rights Reserved. The information provided is
                        for consumers' personal, noncommercial use and may not be used for any purpose other than to
                        identify prospective properties consumers may be interested in purchasing. All properties are
                        subject to prior sale or withdrawal. All information provided is deemed reliable but is not
                        guaranteed accurate, and should be independently verified. Listing courtesy of: <span
                ...
                <p>
                    ...
                    <?php } ?>
                    <?php } ?>
                <p>Real Estate IDX Powered by: <a href="https://www.tremgroup.com" title="TREMGROUP" rel="nofollow"
                ...
                <div class="mb-mcform">
                    <form method="post" class="ib-property-mortgage-f">
                        <ul class="ib-mcinputs">
                            <li class="ib-mcitem">
                                <span class="ib-mgitxt"><?php echo __('Purchase Price', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                            ...
                            <li class="ib-mcitem">
                                <span class="ib-mgitxt"><?php echo __('Year Term', IDXBOOST_DOMAIN_THEME_LANG); ?> (<?php echo __('Years', IDXBOOST_DOMAIN_THEME_LANG); ?>)</span>
                            ...
                            <li class="ib-mcitem">
                                <span class="ib-mgitxt"><?php echo __('Interest Rate(%)', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                            ...
                            <li class="ib-mcitem">
                                <span class="ib-mgitxt"><?php echo __('Down Payment(%)', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                                <div class="ib-mgiwrapper">
                                    <label class="ms-hidden"
            ...
            <div class="ib-mgcontent">
                <form method="post" class="flex-save-search-modals">
                    <ul class="ib-msavesearch">
                        <li class="ib-mssitem">
                            <span class="ib-mssitxt"><?php echo __('Name your search', IDXBOOST_DOMAIN_THEME_LANG); ?>*</span>
                            <div class="ib-mgiwrapper">
                                <label class="ms-hidden"
                        ...
                        <li class="ib-mssitem">
                            <span class="ib-mssitxt"><?php echo __('Email Updates', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                            <div class="ib-mgiwrapper ib-mgwselect">
                                <label class="ms-hidden"
                        ...
                        <li class="ib-mssitem">
                            <span class="ib-mssitxt"><?php echo __('Only Update me On', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                        ...
                        <div class="ib-pvwcta">
                            <ul class="ib-pvcta">
                                ...
                                <li class="ib-pvitem" data-id="video">
                                    <a class="ib-plvideo ms-video-fs" href="{{virtual_tour}}" title="Virtual Tour"
                                       target="_blank" data-type="link"
                                       rel="nofollow"><?php echo __("Virtual Tour", IDXBOOST_DOMAIN_THEME_LANG); ?></a>
                                </li>
                                {{/if}}
                            </ul>
                    ...
                    <div class="ib-pbia">
                        <div class="ib-pwinfo">
                            <div class="ib-pinfo">
                                <div class="ib-pilf">
                                    ...
                                    <ul class="ib-pilist">
                                        ...
                                        <li class="ib-pilitem ib-pilsize"><span
                                                    class="ib-pilnumber">{{sqft}}</span><span
                                                    class="ib-piltxt"><?php echo __("Size sqft", IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                                ...
                                <ul class="ib-psc" style="display: none">
                                    <li class="ib-pscitem ib-pshared">
                                        ...
                                        <div class="ib-plsocials">
                                            <a class="ib-plsitem ib-plsifb" href="{{ propertyPermalink slug }}"
                                               rel="nofollow"><span class="ib-plsitxt">Facebook</span></a>
                                            <a class="ib-plsitem ib-plsitw" href="{{ propertyPermalink slug }}"
                                               data-address="{{ address_short }} {{ address_large}}"
                                               data-price="{{price}}" data-type="{{class_id}}"
                                               data-rental="{{is_rental}}" data-mls="{{mls_num}}" rel="nofollow"><span
                                ...
                                <div class="ib-pdescription-title"
                                     style="display: block !important;position: relative;font-size: 14px;padding: 15px 15px 0 15px;margin-bottom: 0;border-bottom: 1px dashed #ccc; padding-bottom: 15px; font-weight: normal; color: #858585; order:3"><?php echo __("Presented by:", IDXBOOST_DOMAIN_THEME_LANG); ?>
                                    {{agent_name}} <?php echo __("of", IDXBOOST_DOMAIN_THEME_LANG); ?> {{office_name}}
                                    {{#if agent_phone }}
                                    / Ph: {{agent_phone}}
                                    {{/if}}
                                </div>
                                ...
                                <div class="ib-plist-details">
                                    ...
                                    <div class="ib-plist-card">
                                        ...
                                        <ul class="ib-plist-list">
                                            ...
                                            <li>
                                                <span class="ib-plist-st"><?php echo __("Features", IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                            ...
                            <div class="ib-bdisclaimer ib-bdisclaimer-desktop">
                                ...
                                {{else}}
                                <p>The multiple listing information is provided by the {{board_name}}® from a
                                    copyrighted compilation of listings.
                                    The compilation of listings and each individual listing are
                                    &copy;<?php echo date('Y'); ?>-present {{board_name}}®.
                                    ...
                                    Listing courtesy of: <span class="ib-bdcourtesy">{{office_name}}</span> <a
                                            class="ib-phone-office" href="tel:{{phone_office}}">Ph.{{phone_office}}</a>
                                </p>
                                {{/if}}
                                <p>Real Estate IDX Powered by: <a href="https://www.tremgroup.com" title="TREMGROUP"
                                                                  rel="nofollow" target="_blank">TREMGROUP</a></p>
                            </div>
                        ...
                        <div class="ib-bdisclaimer ib-bdisclaimer-mobile">
                            ...
                            {{{ idxBoardDisclaimer this }}}
                            {{else}}
                            <p>The multiple listing information is provided by the {{board_name}}® from a copyrighted
                                compilation of listings.
                                The compilation of listings and each individual listing are
                                &copy;<?php echo date('Y'); ?>-present {{board_name}}®.
                                All Rights Reserved. The information provided is for consumers' personal, noncommercial
                                use and may not be used for any purpose
                                ...
                                All information provided is deemed reliable but is not guaranteed accurate, and should
...
<script id="ib-aside-template" type="text/x-handlebars-template">
    ...
    <li class="ib-pitem" data-geocode="{{ lat }}:{{ lng }}" data-mls="{{ mls_num }}" data-status="{{ status }}">
        <ul class="ib-piinfo">
            ...
            <li class="ib-piitem ib-pisqft">{{ formatLotSize lot_size
                }} <?php echo __('Lot Size', IDXBOOST_DOMAIN_THEME_LANG); ?></li>
            <li class="ib-piitem ib-paddress">{{ full_address }}</li>
            <?php if (in_array($flex_idx_info["board_id"], ["31"])) { ?>
                <li class="ib-piitem ib-small-text" style="font-size: 12px;margin-top: 5px;">Listing Provided by NWMLS
                </li>
            <?php } ?>

            <?php if (in_array($flex_idx_info["board_id"], ["33"])) { ?>
                <li class="ib-piitem ib-small-text" style="font-size: 12px;margin-top: 5px;">Listing Courtesy of
                    {{office_name}}
                </li>
            <?php } ?>
        ...
        <div class="ib-body-modal-filters-mobile">
            <div class="ib-wrap-collapse">
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                ...
                                <label for="ib-min-price"
                                       class="ms-hidden"><?php echo __('Minimum', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                                <input class="notranslate ib-iffrom ib-ubrange-lbl-lt" id="ib-min-price" type="text"
                                       value="">
                            ...
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                ...
                                <label for="ib-max-price"
                                       class="ms-hidden"><?php echo __('Maximum', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                                <input class="notranslate ib-iffrom ib-ubrange-lbl-lt" id="ib-max-price" type="text"
                                       value="">
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                ...
                                <label for="ib-min-rent-price"
                                       class="ms-hidden"><?php echo __('Minimum', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                                <input class="notranslate ib-iffrom ib-ubrange-lbl-lt" id="ib-min-rent-price"
                                       type="text" value="">
                                <span class="ib-label-wrap-fm"><?php echo __('Minimum', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                            </div>
                            <div class="ib-item-wrap-fm ib-sp-fm ib-sp-fm-tp"><?php echo __('to', IDXBOOST_DOMAIN_THEME_LANG); ?></div>
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                ...
                                <label for="ib-max-rent-price"
                                       class="ms-hidden"><?php echo __('Maximum', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                                <input class="notranslate ib-iffrom ib-ubrange-lbl-lt" id="ib-max-rent-price"
                                       type="text" value="">
                                <span class="ib-label-wrap-fm"><?php echo __('Maximum', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                            </div>
                        </div>
                ...
                <div class="ib-item-collapse -mb">
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <ul class="ib-wrap-fm ib-cl-2" id="ib-flex-m-types"
                                style="max-height:218px;overflow-y:scroll;"></ul>
                        </div>
                        <?php if (isset($c_search_settings['idx_listings_type']) && (1 == $c_search_settings['idx_listings_type'])): ?>
                            <div class="ib-pending-contigent">
                                <input type="checkbox" id="pendingContigentMobile" value="1"
                                       class="ib-icheck" <?php if (isset($c_search_settings['hide_pending_content_options']) && (1 == $c_search_settings['hide_pending_content_options'])): ?> checked <?php endif; ?>>
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                ...
                                <label for="ib-min-living"
                                       class="ms-hidden"><?php echo __('Minimum', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                                <input class="notranslate ib-iffrom ib-ubrange-lbl-lt" type="text" id="ib-min-living"
                                       value="">
                                <span class="ib-label-wrap-fm"><?php echo __('Minimum', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                            </div>
                            <div class="ib-item-wrap-fm ib-sp-fm ib-sp-fm-tp"><?php echo __('to', IDXBOOST_DOMAIN_THEME_LANG); ?></div>
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                ...
                                <label for="ib-max-living"
                                       class="ms-hidden"><?php echo __('Maximum', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                                <input class="notranslate ib-iffrom ib-ubrange-lbl-lt" type="text" id="ib-max-living"
                                       value="">
                                <span class="ib-label-wrap-fm"><?php echo __('Maximum', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                            </div>
                        </div>
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                ...
                                <label for="ib-min-bsize"
                                       class="ms-hidden"><?php echo __('Minimum', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                                <input class="notranslate ib-iffrom ib-ubrange-lbl-lt" type="text" id="ib-min-bsize"
                                       value="">
                                <span class="ib-label-wrap-fm"><?php echo __('Minimum', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                            </div>
                            <div class="ib-item-wrap-fm ib-sp-fm ib-sp-fm-tp"><?php echo __('to', IDXBOOST_DOMAIN_THEME_LANG); ?></div>
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                ...
                                <label for="ib-max-bsize"
                                       class="ms-hidden"><?php echo __('Maximum', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                                <input class="notranslate ib-iffrom ib-ubrange-lbl-lt" type="text" id="ib-max-bsize"
                                       value="">
                                <span class="ib-label-wrap-fm"><?php echo __('Maximum', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                            </div>
                        </div>
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                ...
                                <label for="ib-min-land"
                                       class="ms-hidden"><?php echo __('Minimum', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                                <input class="notranslate ib-iffrom ib-ubrange-lbl-lt" type="text" id="ib-min-land"
                                       value="">
                                <span class="ib-label-wrap-fm"><?php echo __('Minimum', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                            </div>
                            <div class="ib-item-wrap-fm ib-sp-fm ib-sp-fm-tp"><?php echo __('to', IDXBOOST_DOMAIN_THEME_LANG); ?></div>
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                ...
                                <label for="ib-max-land"
                                       class="ms-hidden"><?php echo __('Maximum', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                                <input class="notranslate ib-iffrom ib-ubrange-lbl-lt" type="text" id="ib-max-land"
                                       value="">
                                <span class="ib-label-wrap-fm"><?php echo __('Maximum', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                            </div>
                        </div>
                        <ul class="ib-wrap-fm ib-cl-2 ib-mtop" style="display:none !important;">
                            <li class="ib-item-wrap-fm ib-btn-chk-fm">
                                <input type="radio" name="lotsize_measure_type" class="lotsize-measure-type"
                                       value="acres" id="m_lotsize_measure_type_acres">
                                <label for="m_lotsize_measure_type_acres">ACRES</label>
                            </li>
                            <li class="ib-item-wrap-fm ib-btn-chk-fm">
                                <input type="radio" name="lotsize_measure_type" class="lotsize-measure-type" value="sf"
                                       id="m_lotsize_measure_type_sf">
                ...
                <div class="ib-item-collapse">
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label for="ib-min-beds"
                                       class="ms-hidden"><?php echo __('Minimum', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                                <input class="notranslate ib-iffrom ib-ubrange-lbl-lt" id="ib-min-beds" type="text"
                                       value="">
                            ...
                            <div class="ib-item-wrap-fm ib-sp-fm ib-sp-fm-tp"><?php echo __('to', IDXBOOST_DOMAIN_THEME_LANG); ?></div>
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label for="ib-max-beds"
                                       class="ms-hidden"><?php echo __('Maximum', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                                <input class="notranslate ib-iffrom ib-ubrange-lbl-lt" id="ib-max-beds" type="text"
                                       value="">
                ...
                <div class="ib-item-collapse">
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label for="ib-min-caprate"
                                       class="ms-hidden"><?php echo __('Minimum', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                                <input class="notranslate ib-iffrom ib-ubrange-lbl-lt" type="text" id="ib-min-caprate"
                                       value="">
                                <!-- <select id="ib-min-year"></select> -->
                                <span class="ib-label-wrap-fm"><?php echo __('Minimum', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                            </div>
                            <div class="ib-item-wrap-fm ib-sp-fm ib-sp-fm-tp"><?php echo __('to', IDXBOOST_DOMAIN_THEME_LANG); ?></div>
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label for="ib-max-caprate"
                                       class="ms-hidden"><?php echo __('Maximum', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                                <input class="notranslate ib-iffrom ib-ubrange-lbl-lt" type="text" id="ib-max-caprate"
                                       value="">
                                <!-- <select id="ib-max-year"></select> -->
                                <span class="ib-label-wrap-fm"><?php echo __('Maximum', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                            </div>
