                        ...
                        <ul class="ib-mcinputs">
                            ...
                            <li class="ib-mcitem"><span class="ib-mgitxt"><?php echo __('Term', IDXBOOST_DOMAIN_THEME_LANG); ?></span>
                                <div class="ib-mgiwrapper ib-mgwselect">
                                  <label class="ms-hidden" for="ib-mcsyears-a"><?php echo __('Select year', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                    ...
                    <div class="ib-pwheader">
                        ...
                        <div class="ib-phcta">
                            <div class="ib-phomodal">
                                ...
                                <button class="ib-pbtnopen ib-phbtn" data-permalink="{{ propertyPermalink slug }}"><?php echo __('Open', IDXBOOST_DOMAIN_THEME_LANG); ?></button>
