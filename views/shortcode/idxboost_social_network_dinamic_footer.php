...
echo '<div class="ip-social">';

if ($facebook_social_url) {
    echo ' <a class="ip-social-link idx-icon-facebook" 
...
if ($twitter_social_url) {
    echo '  <a class="ip-social-link idx-icon-twitter" 
...
if ($youtube_social_url) {
    echo '<a class="ip-social-link idx-icon-youtube" 
                                title="Youtube" aria-label="Follow us on Youtube"
                                href="' . $youtube_social_url . '" 
                                target="_blank" rel="nofollow noopener"></a>';
}
if ($instagram_social_url) {
    echo '<a class="ip-social-link idx-icon-instagram" 
                                title="Instagram" aria-label="Follow us on Instagram"
                                href="' . $instagram_social_url . '" 
                                target="_blank" rel="nofollow noopener"></a>';
}
if ($linkedin_social_url) {
    echo '  <a class="ip-social-link idx-icon-linkedin2" 
...
if ($pinterest_social_url) {
    echo '<a class="ip-social-link idx-icon-pinterest" 
                                title="Pinterest" aria-label="Follow us on Pinterest"
                                href="' . $pinterest_social_url . '" 
                                target="_blank" rel="nofollow noopener"></a>';
}
