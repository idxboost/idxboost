                ...
                <div class="info-content">
                    <div class="ib-bdisclaimer">
                        ...
                        <p>The Registrant acknowledges each other RLS Broker’s ownership of, and the validity of their
                            respective copyright in, the Exlusive Listings that are transmitted over the RLS. The
                            information is being provided by REBNY Listing Service, Inc. Information deemed reliable but
                            not guaranteed. Information is provided for consumers’ personal, non-commercial use, and may
                            not be used for any purpose other than the identification of potential properties for
                            purchase. This information is not verified for authenticity or accuracy and is not
                            guaranteed and may not reflect all real estate activity in the market.
                            ©<?php echo date('Y'); ?> REBNY Listing Service, Inc. All rights reserved.</p>
                    </div>
                </div>
            </div>
        <?php } ?>
    ...
    <div class="ib-content-modal-filters-mobile">
        ...
        <div class="ib-header-modal-filters-mobile">
		  ...
		  <?php endif; ?>-->
            ...
            <button class="ib-close-modal-filters-mobile" alt="<?php echo __('Close', IDXBOOST_DOMAIN_THEME_LANG); ?>">
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-min-price"><?php echo __('Minimum', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                            ...
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-max-price"><?php echo __('Maximum', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                ...
                <div class="ib-item-collapse ib-item-collapse-saletype ib-item-collapse-rent" style="display:none;">
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-min-rent-price"><?php echo __('Minimum', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                            ...
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-max-rent-price"><?php echo __('Maximum', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                ...
                <div id="ib-bedrooms-collapse" class="ib-item-collapse">
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-min-beds"><?php echo __('Minimum', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                            ...
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-max-beds"><?php echo __('Maximum', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                ...
                <div class="ib-item-collapse">
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-min-baths"><?php echo __('Minimum', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                            ...
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-max-baths"><?php echo __('Maximum', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                ...
                <div class="ib-item-collapse">
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-min-living"><?php echo __('Minimum', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                            ...
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-max-living"><?php echo __('Maximum', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                ...
                <div class="ib-item-collapse">
                    ...
                    <div class="ib-body-collpase">
                        <div class="ib-wrap-fm">
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-min-land"><?php echo __('Min Size', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
                            ...
                            <div class="ib-item-wrap-fm ib-wrap-content-select">
                                <label class="ms-hidden"
                                       for="ib-max-land"><?php echo __('Max Size', IDXBOOST_DOMAIN_THEME_LANG); ?></label>
