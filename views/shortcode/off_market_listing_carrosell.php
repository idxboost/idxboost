...
<section data-limit="<?php echo $atts['limit']; ?>" data-gallery="<?php echo $gallery_val; ?>" data-item="<?php echo $atts['slider_item']; ?>" class="featured-section flex-block-description mtop-60 ib-off-market-listing-slider ib-off-market-listing-slider-<?php echo $class_filter; ?>" data-filter="<?php echo $class_filter; ?>" id="featured-section">
