...
<?php
  ...
  $viewfilter='grid';
  ?>
<div class="clidxboost-sc-filters ms-shortcode-commercial idxboost-content-filter-<?php echo $class_multi; ?>" filtemid="<?php echo $class_multi; ?>">
      ...
      <ul id="sub-filters">
        ...
        <li id="filter-by" class="clidxboost-icon-arrow-select">
          ...
          <select id="flex_idx_sort" class="flex_idx_sort flex_idx_sort-<?php echo $class_multi; ?>" data-permalink="<?php the_permalink(); ?>" data-currpage="<?php echo $response['pagination']['current_page_number']; ?>" filtemid="<?php echo $class_multi; ?>">
              ...
              <option value="lot_size-asc" <?php selected($atts["order_by"], "lot_size-asc"); ?>><?php echo __("Lowest Lot Size", IDXBOOST_DOMAIN_THEME_LANG); ?></option>
          </select>
        </li>
