          ...
          <div class="ib-pwheader {{stylesInput.headerSection.format}}">
            ...
            <div class="ib-phcta">
              <div class="ib-phomodal">
                ...
                {{/if}}
                <button class="ib-requestinfo ib-phbtn sfm">{{stylesInput.headerSection.button.text}}</button>
                {{#if websiteSlugnameDomain}}
                  <a href="{{websiteSlugnameDomain}}" class="ib-phbtn -order" target="_blank">
                    <i class="idx-icon-open"></i> <?php echo __("Open", IDXBOOST_DOMAIN_THEME_LANG); ?>
                  </a>
                {{/if}}
                <button class="ib-pbtnclose ib-phbtn">
        ...
        <div class="ib-pcontent">
          <div class="ib-sps-page js-ib-sps-page">
            ...
            <div class="sps-section" id="sps-footer">
              ...
              {{#if (eq user.company_sps_footer_name "idxboost")}}
                <div class="ip-footer-bottom sps-bottom-footer ibc-u-flex-row-reverse ibc-u-justify-content-between ip-mt-5 ip-py-2 ip-px-0 ip-text-center body-xs">
              {{else if (eq user.company_sps_footer_name "tremgroup")}}
                <div class="ip-footer-bottom sps-bottom-footer ibc-u-flex-row-reverse ibc-u-justify-content-between ip-mt-5 ip-py-2 ip-px-0 ip-text-center body-xs">
              {{else}}
                <div class="ip-footer-bottom sps-bottom-footer ibc-u-flex-row-reverse ibc-u-justify-content-center ip-mt-5 ip-py-2 ip-px-0 ip-text-center body-xs">
              {{/if}}
                  
                {{#ifequals user.company_sps_footer_name "idxboost"}}
                  <div class="ibc-c-logo-designer-wrapper ibc-u-align-items-center ibc-u-justify-content-center">
                    ...
                    <a class="ibc-c-logo-designer-link ip-position-relative ip-d-inline-block ibc-s-color-idxboost"
                      href="https://www.idxboost.com" target="_blank" rel="{{#if user.company_sps_footer_follow}}follow{{else}}nofollow{{/if}}"
                ...
                {{#ifequals user.company_sps_footer_name "tremgroup"}}
                  <div class="ibc-c-logo-designer-wrapper ibc-u-align-items-center ibc-u-justify-content-center">
                    <div  class="ibc-c-logo-designer-img">
                      <img src="https://idxboost-spw-assets.idxboost.us/assets/images/logo-tremgroup-150x18.svg" 
                        alt="The Real Estate Marketing Group Logo" 
                        title="The Real Estate Marketing Group" width="150" />
                    </div>
                    
                    Powered by
                    
                    <a class="ibc-c-logo-designer-link ip-position-relative ip-d-inline-block"
                      href="https://www.tremgroup.com" target="_blank" rel="{{#if user.company_sps_footer_follow}}follow{{else}}nofollow{{/if}}"
                ...
                <div class="ip-footer-links ip-d-flex ibc-u-align-items-center ibc-u-justify-content-center ibc-u-flex-wrap">
                  <a class="sp-show-modal" href="/terms-and-conditions/" 
                    title="<?php echo __("Go to Privacy page", IDXBOOST_DOMAIN_THEME_LANG); ?>" rel="nofollow"
                    data-modal=".js-ib-sp-modal-privacy">
                    <?php echo __("Privacy", IDXBOOST_DOMAIN_THEME_LANG); ?></a> |
                  <a class="sp-show-modal" href="terms-and-conditions/#atospp-privacy" 
                    title="<?php echo __("Go to Terms of Service page", IDXBOOST_DOMAIN_THEME_LANG); ?>" rel="nofollow"
                    data-modal=".js-ib-sp-modal-privacy">
                    <?php echo __("Terms and Conditions", IDXBOOST_DOMAIN_THEME_LANG); ?></a> |
                  <a class="sp-show-modal" href="/accessibility/" 
                    title="<?php echo __("Go to Accessibility page", IDXBOOST_DOMAIN_THEME_LANG); ?>" rel="nofollow"
                    data-modal=".js-ib-sp-modal-accessibility">
