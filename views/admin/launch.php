...
<div class="wrap" id="idx-upload-form">
  ...
  <div class="logo-idx">
    ...
    <h1>My IP: <?php echo gethostbyname($_SERVER['HTTP_HOST']); ?></h1>
  </div>
  <h1>Launch My Site</h1>
  <form method="post" id="flex_idx_client_form">
    <input type="hidden" name="action" value="flex_connect_launch">
    <table class="form-table">
      <tbody>
        <tr>
          <td>
            <label for="flex-idx-settings-client-id">Domain Name: ( Example : www.mydomain.com ) </label>
            <input type="text" id="flex-idx-settings-client-id" name="flex_idx_registration_launch" value="<?php echo $flex_idx_registration_launch; ?>" class="widefat" required>
          </td>
        </tr>
      </tbody>
    </table>
    ...
    <p class="submit">
      <span class="btn-content-idx">
        <input type="submit" value="Submit" id="flex_idx_verify_credentials" class="btn-site">
      </span>
    </p>
    <div class="info-synchronize">
      ...
      <ul>
        ...
        <li>On the DNS Management page, in the Records section, edit A record and Enter the IP address your domain name uses for this host record.</li>
        <li>Make any changes to the record, and click Save when finished.</li>
      </ul>
    </div>
  </form>
</div>
