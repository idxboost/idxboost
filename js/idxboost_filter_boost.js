...
Handlebars.registerHelper('DFhandleTypeView', function(property) {
	if (typeof view_grid_type == "string" && view_grid_type=='1'){
	    return '<h2 title="' + property.full_address + '"><span>'+property.full_address_top+'</span><span>'+property.full_address_bottom+'</span></h2>';
	  }else{
	    return '<h2 title="' + property.full_address + '"><span>' + property.full_address + '</span></h2>';
	}
});
