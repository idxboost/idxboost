        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                for (var i = 0, l = items.length; i < l; i++) {
                    ...
                    listingHTML.push('<li class="living-size"> <span>' + _.formatPrice(item.sqft) + '</span>Sq.Ft. <span>(' + item.living_size_m2 + ' m²)</span></li>');
                    listingHTML.push('<li class="price-sf"><span>$' + item.price_sqft + ' </span>/ Sq.Ft.<span>($' + item.price_sqft_m2 + ' m²)</span></li>');
                    if (item.development !== '') {
